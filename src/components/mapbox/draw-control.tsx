import { MutableRefObject, memo, useContext, useEffect, useRef } from 'react'
import MapboxDraw, {
  DrawCreateEvent,
...
function setStyleProperties(
  ...
  console.log('feature node update', featureNode)
...
const DrawControl = ({
  ...
  useEffect(() => {
    console.log('feature node update', featureNodes)
      ...
      featureNodes?.forEach((node) => {
        ...
        if (!node.visible) {
          ...
          if (displayFeatureIds?.includes(node.id)) {
            ...
            console.log('display feature', feature)
